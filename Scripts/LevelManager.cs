...
public class LevelManager : MonoBehaviour
{
    ...
    //fitur tambahan untuk menambahkan fitur Currency
    ...
    public int Currency
    {
        ...
        {
            this.currency = value;
            this.currencyTxt.text = value.ToString() + "<color=lime>E</color>";
        }
    }
    ...
    private void InstantiateAllTowerUI()
    {
        ...
        {
            //menambahkan fungsi if tujuannya ketika curren energy nya lebih besar dari energy tower maka tower akan ditampikan
            //belum 100% terpenuhi(berfungsi/masih ngebug)
            if (Currency >= tower.Energy)
                {
            ...
            else
            {
                ...
                newTowerUIObj.gameObject.SetActive(false);
                newTowerUI.gameObject.SetActive(false);
            }
